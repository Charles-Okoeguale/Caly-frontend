...
import UserQuestionsPage from "views/user";
...
const UserQuestions: React.FC<Props> = ({
  user,
  error,
  noResponse,
  noUser,
      ...
      description={
        user
          ? `${capitalizeString(
              // @ts-ignore
              username,
            )} has a challenge for you on Caly. Get started by answering their questions and let them know what you think about them!`
